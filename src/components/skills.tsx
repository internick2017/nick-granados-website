              ...
              {skills.map((skill, index) => (
                <div key={skill.name}>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-brand-primary-text dark:text-slate-300 font-medium">{skill.name}</span>
                    <span className="text-brand-secondary-text dark:text-slate-400 text-sm">{skill.level}%</span>
                  </div>
          ...
          >
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-4">
              {technologies.map((tech, index) => (
                ...
                >
                  <span className="text-sm font-medium text-brand-primary-text dark:text-slate-300">{tech}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
