  ...
  },
  {
    ...
    caseStudy: {
      ...
      es: {
        ...
        approach: [
          'La tienda se construó como un tema de Shopify personalizado sobre su propio dominio, no una plantilla por defecto.',
          'Sirvió tres idiomas con señalización hreflang correcta para inglés, español y portugués más un fallback por defecto, así los buscadores resuelven la versión correcta según el mercado.',
          'La moneda y el locale se manejaron con el formulario de localización de Shopify, así el precio seguía al mercado del visitante en vez de quedar fijo en una sola moneda.',
        ...
        outcome: [
          'Tienda construida y operada sobre su propio dominio, con tres idiomas y checkout multimoneda.',
      ...
      pt: {
        ...
        approach: [
          'A loja foi construída como um tema Shopify personalizado no próprio domínio, não um template padrão.',
          'Serviu três idiomas com sinalização hreflang correta para inglês, espanhol e português mais um fallback padrão, então os buscadores resolvem a versão certa por mercado.',
          'Moeda e locale foram tratados pelo formulário de localização do Shopify, então o preço acompanhava o mercado do visitante em vez de ficar fixo numa moeda só.',
        ...
        outcome: [
          'Loja construída e operada no próprio domínio, com três idiomas e checkout multimoeda.',
